...
; Disable windows + space for language keyboard layout
#Space::Return

-------------------------------------------------------------------------------------------------------------------
Open Programs with hotkeys 
-------------------------------------------------------------------------------------------------------------------
# Remove "#" from every instance you want yourself, and add your own path. My paths are not in this file for privacy reasons

#; Apps Key
#;Run "INSERT YOUR OWN PATH HERE" -incognito

#^AppsKey::
#Run "INSERT YOUR OWN PATH HERE"
#return

#+AppsKey::Process, Close, Chrome.exe
#return
...
#return
------------------------------------------------------------------------------------------------------------------
; Page Up and Page Down has been set to volume buttons

PgUp::
SoundSetWaveVolume, +5  ; Decrease the current  level by 5
return

PgDn::
SoundSetWaveVolume, -5  ; Increase the current  level by 5
return
...
; Function keys remaped, but can be used as normal "Fn" keys if shit button is held down
...
::rsj.::full name #(not added in this file for privacy reasons)
::rtlf::phonenb #(not added in this file for privacy reasons)
::rtlf.::phonenb #(not added in this file for privacy reasons)
::rmail::mail #(not added in this file for privacy reasons)
::rsmail::mail #(not added in this file for privacy reasons)
::rads::address #(not added in this file for privacy reasons)
::rads.::address #(not added in this file for privacy reasons)
::radd::address #(not added in this file for privacy reasons)
::radd.::address #(not added in this file for privacy reasons)
::raddr::address #(not added in this file for privacy reasons)
::raddr.::address #(not added in this file for privacy reasons)
...
;   Common Misspellings - the main list (mostly from sources, but also added some of the ones I type wrongly the most)
;   Added list for my most common norwegian entries later on
;------------------------------------------------------------------------------
;------------------------------------------------------------------------------
/*
...
keys = abcdefghijklmnopqrstuvwxyzæøå
Loop Parse, keys
...
;-------------------------------------------------------------------------------
;  Capitalise dates (can be removed if your main language doesndoesn't capitalise)
;-------------------------------------------------------------------------------
::monday::Monday
::tuesday::Tuesday
::wednesday::Wednesday
...
;-------------------------------------------------------------------------------
; My own Norwegian words added into the list
;-------------------------------------------------------------------------------
::hore::høre
::rore:: røre
::dessvere::dessverre
...
::penal::pennal
::overhode::overhodet
::egenhånd::på egen hånd
::idag::i dag
::vere::være
::utifra::ut i fra
::original::original
::anderledes::annerledes
::iallefall::i alle fall
::bevist::bevisst
::blandt::blant
::alikevel::allikevel
::allikevell::allikevel
::alikevell::allikevel
::imorgen::i morgen
::slalom::slalåm
::diskret::diskré
::skjelden::sjelden
::parallellt::parallelt
::paralelt::parallelt
::parralelt::parallelt
::parrallelt::parallelt
::agressiv::aggressiv
::blandt annet::blant annet
...
::ivertfall::i hvert fall
::i vertfall::i hvert fall
::vennelig::vennlig
::venelig::vennlig
::venlig::vennlig
...
::ide::idé
::tilegg::tillegg
::sannsynelig::sannsynlig
::etterhvert::etter hvert
::tilstede::til stede
::på egenhånd::på egen hånd
::"`?"::"?"
::"``?"::"?"
::"`??"::"??"
::"``??"::"??"
